...
| `<TBD-Trae-WebSearch>` | No equivalent — use `web_fetch` with a search engine URL |
...
| Trae IDE agent | Copilot CLI equivalent |
|-------------------|----------------------|
...
Copilot CLI supports persistent async shell sessions, which have no direct Trae IDE equivalent:
